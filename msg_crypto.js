 ...
 */
const WXBizMsgCrypt = (token, encodingAESKey, id) => {
 ...
 */
WXBizMsgCrypt.prototype.getSignature = (timestamp, nonce, encrypt) => {
 ...
 */
WXBizMsgCrypt.prototype.decrypt = (text) => {
 ...
 */
WXBizMsgCrypt.prototype.encrypt = (text) => {
  // 算法：AES_Encrypt[random(16B) + msg_len(4B) + msg + $CorpID]
  // 获取16B的随机字符串
